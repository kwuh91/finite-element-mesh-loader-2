...
int main(int argc, char** argv) {
    std::shared_ptr<GatherDataDirector> gdDirector(new GatherDataDirector());
    std::shared_ptr<StatsDirector> sDirector( new StatsDirector());

    ClientCode(*gdDirector, argv[1], *sDirector);
    // delete gdDirector;
    // delete sDirector;
    return 0;
}
